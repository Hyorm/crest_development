...
# 322 "./b_tree.c"
    ...
    __CrestLoad(518, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(517, (unsigned long )0, (long long )10);
    __CrestApply2(516, 4, (long long )(ch % 10));
# 324 "./b_tree.c"
    printf((char const * __restrict )"%d\n", ch % 10);
    __CrestClearStack(519);
    __CrestLoad(522, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(521, (unsigned long )0, (long long )10);
    __CrestApply2(520, 4, (long long )(ch % 10));
    __CrestStore(523, (unsigned long )(& ch));
# 325 "./b_tree.c"
    ch %= 10;
    {
    {
    __CrestLoad(526, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(525, (unsigned long )0, (long long )1);
    __CrestApply2(524, 12, (long long )(ch == 1));
# 327 "./b_tree.c"
    if (ch == 1) {
      __CrestBranch(527, 256, 1);
# 327 "./b_tree.c"
      goto case_1;
    } else {
      __CrestBranch(528, 257, 0);

    }
    }
    {
    __CrestLoad(531, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(530, (unsigned long )0, (long long )2);
    __CrestApply2(529, 12, (long long )(ch == 2));
# 334 "./b_tree.c"
    if (ch == 2) {
      __CrestBranch(532, 259, 1);
# 334 "./b_tree.c"
      goto case_2;
    } else {
      __CrestBranch(533, 260, 0);

    }
    }
    {
    __CrestLoad(536, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(535, (unsigned long )0, (long long )3);
    __CrestApply2(534, 12, (long long )(ch == 3));
# 341 "./b_tree.c"
    if (ch == 3) {
      __CrestBranch(537, 262, 1);
# 341 "./b_tree.c"
      goto case_3;
    } else {
      __CrestBranch(538, 263, 0);

    }
    }
    {
    __CrestLoad(541, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(540, (unsigned long )0, (long long )4);
    __CrestApply2(539, 12, (long long )(ch == 4));
# 348 "./b_tree.c"
    if (ch == 4) {
      __CrestBranch(542, 265, 1);
# 348 "./b_tree.c"
      goto case_4;
    } else {
      __CrestBranch(543, 266, 0);

    }
    }
    {
    __CrestLoad(546, (unsigned long )(& ch), (long long )ch);
    __CrestLoad(545, (unsigned long )0, (long long )5);
    __CrestApply2(544, 12, (long long )(ch == 5));
# 351 "./b_tree.c"
    if (ch == 5) {
      __CrestBranch(547, 268, 1);
# 351 "./b_tree.c"
      goto case_5;
    } else {
      __CrestBranch(548, 269, 0);
...
# 329 "./b_tree.c"
    ...
    __CrestLoad(550, (unsigned long )(& val), (long long )val);
# 331 "./b_tree.c"
    printf((char const * __restrict )"%d\n", val);
    __CrestClearStack(551);
    __CrestLoad(552, (unsigned long )(& val), (long long )val);
# 332 "./b_tree.c"
    insertion(val);
...
# 336 "./b_tree.c"
    __CrestUInt((unsigned int *)(& val));
    __CrestLoad(555, (unsigned long )(& val), (long long )val);
# 338 "./b_tree.c"
    printf((char const * __restrict )"%d\n", val);
    __CrestClearStack(556);
    __CrestLoad(557, (unsigned long )(& val), (long long )val);
# 339 "./b_tree.c"
    deletion(val, root);
...
# 342 "./b_tree.c"
    ...
    __CrestClearStack(559);
# 343 "./b_tree.c"
    __CrestUInt((unsigned int *)(& val));
    __CrestLoad(560, (unsigned long )(& val), (long long )val);
# 345 "./b_tree.c"
    printf((char const * __restrict )"%d\n", val);
    __CrestClearStack(561);
    __CrestLoad(562, (unsigned long )(& val), (long long )val);
# 346 "./b_tree.c"
    searching(val, & ch, root);
    __CrestClearStack(563);
# 347 "./b_tree.c"
    goto switch_break;
    case_4:
# 349 "./b_tree.c"
...
# 350 "./b_tree.c"
    goto switch_break;
    case_5:
    __CrestLoad(565, (unsigned long )0, (long long )0);
# 352 "./b_tree.c"
    exit(0);
    __CrestClearStack(566);
    switch_default:
    __CrestLoad(567, (unsigned long )(& ch), (long long )ch);
# 354 "./b_tree.c"
    printf((char const * __restrict )"%d U have entered wrong option!!\n", ch);
    __CrestClearStack(568);
    {
    __CrestLoad(571, (unsigned long )(& hyorm), (long long )hyorm);
    __CrestLoad(570, (unsigned long )0, (long long )500);
    __CrestApply2(569, 14, (long long )(hyorm > 500));
# 355 "./b_tree.c"
    if (hyorm > 500) {
      __CrestBranch(572, 282, 1);
      __CrestLoad(574, (unsigned long )0, (long long )1);
      __CrestStore(575, (unsigned long )(& hyorm_flag));
# 355 "./b_tree.c"
      hyorm_flag = 1;
    } else {
      __CrestBranch(573, 283, 0);
      __CrestLoad(578, (unsigned long )(& hyorm), (long long )hyorm);
      __CrestLoad(577, (unsigned long )0, (long long )1);
      __CrestApply2(576, 0, (long long )(hyorm + 1));
      __CrestStore(579, (unsigned long )(& hyorm));
# 356 "./b_tree.c"
      hyorm ++;
    }
    }
# 357 "./b_tree.c"
    ...
    {
    __CrestLoad(582, (unsigned long )(& hyorm_flag), (long long )hyorm_flag);
    __CrestLoad(581, (unsigned long )0, (long long )1);
    __CrestApply2(580, 12, (long long )(hyorm_flag == 1));
# 359 "./b_tree.c"
    if (hyorm_flag == 1) {
      __CrestBranch(583, 287, 1);
# 359 "./b_tree.c"
      goto while_break;
    } else {
      __CrestBranch(584, 288, 0);
...
# 360 "./b_tree.c"
  ...
  __CrestStore(587, (unsigned long )(& __retres5));
# 362 "./b_tree.c"
  __retres5 = 0;
  __CrestLoad(588, (unsigned long )(& __retres5), (long long )__retres5);
  __CrestReturn(589);
# 316 "./b_tree.c"
  return (__retres5);
}
